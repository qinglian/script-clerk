  ...
  <div class="app-container">
    ...
    <div class="sidebar">
      ...
      <el-menu :default-active="activeView" @select="onMenuSelect">
        ...
        <el-menu-item index="install" @click="handleInstallApp">
...
import { EditPen, List, DataAnalysis, Download, Setting, FolderOpened, Monitor } from '@element-plus/icons-vue'
